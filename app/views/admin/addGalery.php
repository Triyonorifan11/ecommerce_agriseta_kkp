...
<form action="<?= BASEURL; ?>/admin/insertGalery" method="post" enctype="multipart/form-data">
    <div class="card mt-4">
        <div class="card-header">
            <h5 class="fw-bold">Data Galery</h5>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-lg-7">
            ...
            <div class="d-grid gap-2">
                <button class="btn btn-primary" type="submit">Upload Galery</button>
            </div>
        </div>
    </div>
</form>
