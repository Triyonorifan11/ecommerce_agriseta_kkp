             ...
             <div class="row" style="margin-bottom: 4rem !important;">
                 <div class="col-md-4">
                     ...
                     <div class="row mb-3">
                         <div class="col-2">
                             <div class="rounded-circle bg-light d-flex justify-content-center p-2">
                                 <img src="<?= ASSETS; ?>/img/ig.png" alt="ig" style="width: 100%;">
                             </div>
                         </div>
                         <div class="col-10 d-flex align-content-center flex-wrap">
                             <p class="p-2"><a href="https://www.instagram.com/agristafruits_oleholeh/" class="nav-link" target="_blank">Instagram</a></p>
                         </div>
                     </div>
                     ...
                     <div class="row mb-3">
                         <div class="col-2">
                             <div class="rounded-circle bg-light d-flex justify-content-center p-2">
                                 <img src="<?= ASSETS; ?>/img/youtube.png" alt="yt" style="width: 100%;">
                             </div>
                         </div>
                         <div class="col-10 d-flex align-content-center flex-wrap">
                     ...
                     <div class="row mb-3">
                         <div class="col-2">
                             <div class="rounded-circle bg-light d-flex justify-content-center p-2">
                                 <img src="<?= ASSETS; ?>/img/facebook.png" alt="fb" style="width: 100%;">
                             </div>
                         </div>
                         <div class="col-10 d-flex align-content-center flex-wrap">
                 ...
                 <div class="col-md-4 col-sm-12 mb-4">
                     <h3 class="mb-4">Bagus Agriseta Mandiri</h3>
                     <a href="https://mail.google.com/mail/u/0/?tab=rm&ogbl#inbox?compose=XBcJlDMmJDBGFWxCCDZnJnFstBrsrlFxKHVQxhnlSJQRrVKzLnlNVxkkqJNDsLmVDZGFMVxtgtFmWkZv" target="_blank" class="text-decoration-none text-light">
                         <p>bagusagriseta2001@gmail.com</p>
                     </a>
                     <p>Telp. (0341) 599659 || WhatsApp <a href="http://wa.me/6281233202006" target="_blank" class="text-decoration-none text-white">081233202006</a></p>
                     <p class="text-white-50 lh-lg">Yang Dari Bagus Selalu Bagus, Yang Dari Batu Selalu Bermutu</p>
                     <small>Jalan Kopral Kasdi No 2 Bumiaji Kota Batu Jawa Timur</small>
